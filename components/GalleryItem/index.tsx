...
import { useShowBiddingContext } from "../DiscoverMoreNFT"

export default function GalleryItem() {
  const showBidding = useShowBiddingContext()
  ...
  return (
    <div className="lg:h-[373px] lg:w-[270px] bg-white rounded-md lg:flex flex-col mb-4 pb-4 lg:mb-0 lg:pb-0">
      ...
      <div className={`mt-3 ml-5 price-eth font-dmSansRegular text-xs ${showBidding ? "" : "invisible"}`}>
      ...
      <div className={`mx-5 flex flex-row mt-4 lg:mt-2 items-center justify-between ${showBidding ? "" : "invisible"}`}>
