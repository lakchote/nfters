...
export default function Footer() {
  return (
    <>
      ...
      <div className="border-t h-1 hidden lg:block border-t-[#F4F4F4] mx-[120px]"></div>
      <div className="flex justify-center text-[#A4A4A4] pb-4 lg:mt-[15px] lg:h-[432px] text-sm font-avertaRegular">
